...
- On average across all days in the dataset,`r max_mean_interval$interval` contains the maximum number of steps.  
...
- The mean total number of steps taken per day of the new dataset is `r mean_steps2`.    
- The median total number of steps taken per day of the new dataset is `r median_steps2`.   
